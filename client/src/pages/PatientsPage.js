                  ...
                  <div key={patient.id} className={styles.patientCard}>
                    ...
                    <div className={styles.cardBody}>
                      ...
                      <div className={styles.cardItem}>
                        ...
                        <span className={styles.value}>{patient.visit_count || 0}</span>
                      </div>

                      <div className={styles.cardItem}>
                        <span className={styles.label}>📆 Última Cita</span>
                        <span className={styles.value}>
                          {patient.last_appointment_date
                            ? new Date(patient.last_appointment_date).toLocaleDateString('es-ES')
                            : 'Sin citas'}
                      ...
                      {patientInsurances[patient.id] && patientInsurances[patient.id].length > 0 && (
                        <div>
                          <span className={styles.label} style={{ marginBottom: '0.5rem', display: 'block' }}>
                            🏥 Obras Sociales
                          </span>
